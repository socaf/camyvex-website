      ...
      <div className="max-w-md w-full">
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">Enter your credentials to access the dashboard - Database Connected! 🚀</p>
          </div>
          ...
          {/* Quick Access Info */}
          <div className="mt-6 p-4 bg-dark border border-gray-800 rounded-xl">
            <h3 className="text-sm font-medium text-white mb-2">Quick Access</h3>
            <div className="space-y-2 text-xs text-gray-400">
              <div>• User Analytics & Statistics</div>
              <div>• Photo Processing Monitoring</div>
              <div>• Subscription Management</div>
              <div>• System Health Dashboard</div>
            </div>
          </div>
        </motion.div>
        ...
        >
          <p className="text-gray-400 text-sm">
            Need help? Contact{' '}
            <a href="mailto:admin@camyvex.com" className="text-primary hover:text-primary/80">
              admin@camyvex.com
            </a>
          </p>
        </motion.div>
